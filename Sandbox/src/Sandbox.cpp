...
public:
	...
	virtual void OnAttach() override
	{
		...
		m_VB = std::unique_ptr<Jasmine::VertexBuffer>(Jasmine::VertexBuffer::Create());
		m_VB->SetData(vertices, sizeof(vertices));

		m_IB = std::unique_ptr<Jasmine::IndexBuffer>(Jasmine::IndexBuffer::Create());
		m_IB->SetData(indices, sizeof(indices));

		m_Shader.reset(Jasmine::Shader::Create("assets/shaders/shader.glsl"));
	}
	...
	virtual void OnUpdate() override
	{
		...
		Jasmine::UniformBufferDeclaration<sizeof(glm::vec4), 1> buffer;
...
private:
	std::unique_ptr<Jasmine::VertexBuffer> m_VB;
	std::unique_ptr<Jasmine::IndexBuffer> m_IB;
