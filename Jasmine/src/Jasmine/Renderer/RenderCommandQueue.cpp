...
#define JM_RENDER_TRACE(...) JM_CORE_TRACE(__VA_ARGS__)
...
namespace Jasmine {
	...
	{
		JM_RENDER_TRACE("RenderCommandQueue::Execute -- {0} commands, {1} bytes", m_CommandCount, (m_CommandBufferPtr - m_CommandBuffer));
