...
namespace Jasmine {
	...
	void VulkanSwapChain::InitSurface(GLFWwindow* windowHandle)
	{
		...
		JM_CORE_ASSERT(graphicsQueueNodeIndex != UINT32_MAX);
		JM_CORE_ASSERT(presentQueueNodeIndex != UINT32_MAX);
	...
	void VulkanSwapChain::Create(uint32_t* width, uint32_t* height, bool vsync)
	{
		...
		JM_CORE_ASSERT(presentModeCount > 0, "");
	...
	{
		JM_CORE_WARN("VulkanContext::OnResize");
	...
	{
		JM_SCOPE_PERF("VulkanSwapChain::BeginFrame");
	...
	{
		JM_SCOPE_PERF("VulkanSwapChain::Present");
		...
		VkResult result;
		{
			JM_SCOPE_PERF("VulkanSwapChain::Present - QueuePresent");
