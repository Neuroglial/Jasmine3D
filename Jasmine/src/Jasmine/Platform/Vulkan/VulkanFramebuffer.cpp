...
namespace Jasmine {
		...
		: m_Specification(spec)
	{
		...
		JM_CORE_ASSERT(spec.Attachments.Attachments.size());
	...
	{
		JM_CORE_TRACE("VulkanFramebuffer::RT_Invalidate");
		...
		for (auto attachmentSpec : m_Specification.Attachments.Attachments)
		{
			...
			{
				JM_CORE_ASSERT(!m_Specification.ExistingImage, "Not supported for color attachments");
