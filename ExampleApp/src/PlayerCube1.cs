...
namespace Example
{
    class PlayerCube1 : Entity
    {
        ...
        public Vector3 NoCollisionColor = new Vector3();
        ...
        void OnUpdate(float ts)
        {
            ...
            else if (Input.IsKeyPressed(KeyCode.B))
                m_PhysicsBody.ApplyLinearImpulse(new Vector2(-movementForce, 0), new Vector2(), true);
            ...
            if (m_CollisionCounter > 0)
                ...
                m_MeshMaterial.Set("u_AlbedoColor", NoCollisionColor);
