...
namespace Jasmine {
	...
	void EditorLayer::OnAttach()
	{
		...
		geoRenderPassSpec.TargetFramebuffer = Jasmine::Framebuffer::Create(geoFramebufferSpec);
		...
		compRenderPassSpec.TargetFramebuffer = Jasmine::Framebuffer::Create(compFramebufferSpec);
	...
	void EditorLayer::OnEvent(Event& _event)
	{
		...
		if (_event.GetEventType() == EventType::MouseScrolled) {
			auto e = dynamic_cast<MouseScrolledEvent*>(&_event);
			m_Camera.MouseZoom(e->GetYOffset());
		}
	}
